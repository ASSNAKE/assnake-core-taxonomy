...
snake_module = assnake.SnakeModule(name = 'assnake-core-taxonomy', 
                           ...
                           snakefiles = ['./cat_bat/workflow.smk', './metaphlan2/workflow.smk', './centrifuge/workflow.smk'],
                           invocation_commands = [mp3_invocation, mp2_invocation, mp2_rare_invocation, centrifuge_invocation],
